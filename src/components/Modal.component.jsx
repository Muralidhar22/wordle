const Modal = ({ setIsModalDisplayed }) => {
  return (
    <div className="modal-overlay" onClick={() => setIsModalDisplayed(false)}>
      <div className="modal-wordle-info" onClick={(e) => e.stopPropagation()}>
        <h1>How To Play</h1>
        ...
        <div className="example-container">
          <div className="example">
            <div className="box box-filled" data-status="correct">
              W
            </div>
        ...
        <div className="example-container">
          <div className="example">
            ...
            <div className="box box-filled" data-status="present">
              I
            </div>
          ...
          <p className="example-description">
            <span>I</span> is in the word and in the wrong spot.
          </p>
        </div>
        <div className="example-container">
          <div className="example">
            ...
            <div className="box box-filled" data-status="absent">
              U
            </div>
            <div className="box box-filled">E</div>
          </div>
          <p className="example-description">
            <span>U</span> is not in the word and in any spot.
          </p>
        </div>
      </div>
    </div>
